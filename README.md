...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('MoMi Hub BF Premium') then
        makefolder('MoMi Hub BF Premium')
    end
    if not _G.Dis and not isfile('MoMi Hub BF Premium/'..Name..'.json') then
        writefile('MoMi Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('MoMi Hub BF Premium') and isfile('MoMi Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('MoMi Hub BF Premium/'..Name..'.json'))
...
local win = library:Window("MoMi",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
